...
// //  1: console.log('object',  str.split('').reverse().join(''))
// //  2: 递归 + 动态规划
// function resverse(str) {
//     if (str == '') return str;
//     else {
//         let problem = str.slice(1);
//         let subsulution = resverse(problem);
//         let result = subsulution + str[0];
//         return result;
//     }
// }
...
// console.log('ma', Maxsum([1,-5,-5,-2,5,-8,8,-2,8]))
// function test(arr,k){

//    return   [...arr.splice(arr.length-k,k),...arr]
// }

//  let q = test([1,2,3,4,5,6,7],3)
//  console.log('q', q)
